...
function LeftColumn() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-[300px]" data-name="Left Column">
      ...
      <div className="aspect-[1080/1080] relative shrink-0 w-full" data-name="Mesa de trabajo 2 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgMesaDeTrabajo21} />
      </div>
    </div>
  );
}
...
function MiddleColumn() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-[300px]" data-name="Middle Column">
      ...
      <div className="aspect-[1080/1350] relative shrink-0 w-full" data-name="Mesa de trabajo 10 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgMesaDeTrabajo101} />
      </div>
    </div>
  );
}
...
function RightColumn() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-[300px]" data-name="Right Column">
      ...
      <div className="aspect-[1080/1920] relative shrink-0 w-full" data-name="Orne-metaads 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgOrneMetaads1} />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      <div className="col-1 ml-[3.4px] mt-[42.48px] relative row-1 size-[62.921px]">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 62.9211 62.9211">
          <circle cx="31.4605" cy="31.4605" fill="var(--fill-0, #99FFFE)" id="Ellipse 12" r="31.4605" />
        </svg>
      </div>
      <div className="col-1 ml-[3.4px] mt-[287.08px] relative row-1 size-[62.921px]">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 62.9211 62.9211">
          <circle cx="31.4605" cy="31.4605" fill="var(--fill-0, #974CFF)" id="Ellipse 13" r="31.4605" />
        </svg>
      </div>
      <div className="col-1 h-[167.126px] ml-[3.4px] mt-[112.86px] relative rounded-[140px] row-1 w-[62.672px]" style={{ backgroundImage: "linear-gradient(178.166deg, rgb(153, 255, 254) 21.326%, rgb(151, 71, 255) 99.487%)" }} />
      <p className="col-1 font-['DM_Sans:ExtraLight',sans-serif] font-extralight leading-[normal] ml-0 mt-0 relative row-1 text-[16px] text-white whitespace-nowrap" style={{ fontVariationSettings: "'opsz' 14" }}>
        #99FFFE
      </p>
    </div>
  );
  ...
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      <div className="col-1 ml-[1.7px] mt-[42.48px] relative row-1 size-[62.921px]">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 62.9211 62.9211">
          <circle cx="31.4605" cy="31.4605" fill="var(--fill-0, #A772FF)" id="Ellipse 13" r="31.4605" />
        </svg>
      </div>
      <div className="col-1 ml-[1.7px] mt-[287.08px] relative row-1 size-[62.921px]">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 62.9211 62.9211">
          <circle cx="31.4605" cy="31.4605" fill="var(--fill-0, #1C59FF)" id="Ellipse 14" r="31.4605" />
        </svg>
      </div>
...
function Group1() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      ...
      <div className="col-1 ml-[1.7px] mt-[287.08px] relative row-1 size-[62.921px]">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 62.9211 62.9211">
          <circle cx="31.4605" cy="31.4605" fill="var(--fill-0, #D699FF)" id="Ellipse 15" r="31.4605" />
        </svg>
      </div>
  ...
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      ...
      <div className="col-1 h-[62.864px] ml-[5.1px] mt-[42.48px] relative row-1 w-[63.714px]">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 63.7137 62.8642">
          <ellipse cx="31.8568" cy="31.4321" fill="var(--fill-0, #D699FF)" id="Ellipse 15" rx="31.8568" ry="31.4321" />
        </svg>
      </div>
      <div className="col-1 h-[62.864px] ml-[5.1px] mt-[287.14px] relative row-1 w-[63.714px]">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 63.7137 62.8642">
          <ellipse cx="31.8568" cy="31.4321" fill="var(--fill-0, #1B1B1B)" id="Ellipse 16" rx="31.8568" ry="31.4321" />
        </svg>
      </div>
...
function Frame() {
  return (
    <div className="bg-black col-1 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex gap-[35px] items-center justify-center ml-0 mt-0 px-[60px] py-[48px] relative rounded-[41px] row-1 w-[466px]">
      <div aria-hidden="true" className="absolute border border-black border-solid inset-0 pointer-events-none rounded-[41px]" />
      <Group3 />
      <Group2 />
      <Group1 />
      <Group4 />
...
function Group5() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[733.1px] mt-0 place-items-start relative row-1">
      <div className="col-1 h-[572.451px] ml-0 mt-[29.05px] relative row-1 w-[315.607px]" data-name="bootcamp-mobile2">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[100.09%] left-[-12.97%] max-w-none top-[-0.05%] w-[112.97%]" src={imgBootcampMobile2} />
        </div>
      </div>
      <div className="col-1 h-[657.625px] ml-[169.03px] mt-0 relative row-1 w-[324.851px]" data-name="bootcamp-mobile1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
    ...
    <div className="h-[8.74px] relative w-[10.38px]" data-name="🦆 icon 'arrow right'">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.3804 8.74047">
        <g id="ð¦ icon 'arrow right'">
          <path d={svgPaths.p1b4d54c0} fill="var(--fill-0, #1C59FF)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Container9() {
  return (
    <div className="content-stretch flex flex-col gap-[96px] items-start relative shrink-0 w-full" data-name="Container">
      <Hack />
      <Container12 />
      <Group6 />
    </div>
...
function Mockup() {
  return (
    <div className="absolute contents left-[768px] top-[7091px]" data-name="MOCKUP">
      <div className="absolute flex h-[427.892px] items-center justify-center left-[768px] top-[7091px] w-[576.308px]" style={{ "--transform-inner-width": "1185", "--transform-inner-height": "19" } as React.CSSProperties}>
        <div className="flex-none rotate-[-6.84deg]">
          <div className="h-[366.619px] relative w-[536.47px]" data-name="bootmockup 1">
            <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgBootmockup1} />
          </div>
        </div>
      </div>
      <div className="absolute flex h-[83.161px] items-center justify-center left-[789.73px] top-[7447.21px] w-[335.664px]" style={{ "--transform-inner-width": "1185", "--transform-inner-height": "19" } as React.CSSProperties}>
        <div className="flex-none rotate-[-5.37deg]">
          <div className="h-[52.303px] relative w-[332.228px]">
            <div className="absolute inset-[-45.89%_-7.22%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 380.228 100.303">
                <g filter="url(#filter0_f_1_786)" id="Ellipse 35">
                  <ellipse cx="190.114" cy="50.1513" fill="url(#paint0_radial_1_786)" fillOpacity="0.4" rx="166.114" ry="26.1513" />
                </g>
                <defs>
                  <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="100.303" id="filter0_f_1_786" width="380.228" x="0" y="0">
                    <feFlood floodOpacity="0" result="BackgroundImageFix" />
                    <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                    <feGaussianBlur result="effect1_foregroundBlur_1_786" stdDeviation="12" />
                  </filter>
                  <radialGradient cx="0" cy="0" gradientTransform="translate(190.114 50.1513) scale(166.114 26.1513)" gradientUnits="userSpaceOnUse" id="paint0_radial_1_786" r="1">
                    <stop />
...
export default function DevlightsDigitalCampaigns() {
  return (
    <div className="bg-white relative w-full" data-name="Devlights Digital Campaigns">
      <Body />
    </div>
  );
}